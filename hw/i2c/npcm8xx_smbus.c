...
static const Property npcm8xx_smbus_properties[] = {
    DEFINE_PROP_UINT8("fifo-size", NPCM8xxSMBusState, fifo_size, 32),
    DEFINE_PROP_UINT8("tx-bytes-mask", NPCM8xxSMBusState, tx_bytes_mask, 0x3F),
    DEFINE_PROP_UINT8("rx-bytes-mask", NPCM8xxSMBusState, rx_bytes_mask, 0x3F),
    DEFINE_PROP_UINT8("last-bit", NPCM8xxSMBusState, last_bit, BIT(7)),
};
...
static void npcm7xx_smbus_class_init(ObjectClass *klass, const void *data)
{
    ...
    device_class_set_props(dc, npcm8xx_smbus_properties);
